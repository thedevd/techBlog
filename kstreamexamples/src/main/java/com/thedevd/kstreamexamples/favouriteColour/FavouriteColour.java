...
/*
 * Problem - We want to keep count of user's favorite color.
 * For ex - 
 * Ravi, blue    -----------> blue count is 1
 * 
 * Now lets say Ravi changed his favorite color so-
 * Ravi, green   -----------> blue count is 0 and green count is 1
 * 
 * Dev, green 	 -----------> green count is now 2
 * 
 * Ravi, red	 -----------> green will now 1 and red is 1
 * 
 * So we want to keep only count of user's updated favorite color
 */
...
public class FavouriteColour {
    ...
    public static void main(String[] args) {
        ...
        // At this point we have null keys like <null, dev,blue>
