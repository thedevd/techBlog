...
/*
Each time when you add item to HashSet, internally it calls hashcode() method and
if hashcode() retunred matches with any exitent item then equals() gets called to 
check equality and if equals() return true it means item is already there in hashset
thus wont allow that duplicate item.
*/
